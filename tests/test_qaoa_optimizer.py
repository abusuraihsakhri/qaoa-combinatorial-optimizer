...
import pytest
from qaoa_optimizer.models import FrontierPayload, ExecutionStatus
from qaoa_optimizer.engine import FrontierDomainEngine
from qaoa_optimizer.agents import IsingHamiltonianAgent, MixerHamiltonianAgent, ApproximationRatioAgent, QAOACoordinator
from qaoa_optimizer.cli import main


def test_sub_agents():
    a1 = IsingHamiltonianAgent()
...
def test_coordinator():
    ...
    assert "QAOA Quantum Optimization Protocol" in ans or "specifications" in ans
